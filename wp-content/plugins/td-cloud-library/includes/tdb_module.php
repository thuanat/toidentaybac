        ...
        $buffy = '';
            ...
            if ( get_post_format( $this->post['post_id'] ) == 'video' ) {
                ...
                if ( $use_small_post_format_icon_size === true ) {
                    $buffy .= '<span class="td-video-play-ico td-video-small"><img width="20" height="20" class="td-retina" src="' . TDC_URL_LEGACY . '/assets/images/icons/video-small.png' . '" alt="video"/></span>';
                } else {
                    $buffy .= '<span class="td-video-play-ico"><img width="40" height="40" class="td-retina" src="' . TDC_URL_LEGACY . '/assets/images/icons/ico-video-large.png' . '" alt="video"/></span>';
                }
            } // end on video if
