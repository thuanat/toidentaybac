var tdcNotice;
(function(f,d){tdcNotice={$_noticeWrapper:d,_isInitialized:!1,_errorNotices:[],notice:function(b,e,a){var c={};_.isUndefined(e)||!0!==e||(c.type="error");_.isUndefined(a)||!0!==a||(c.hasClose=!0);tdcNotice.showNotice(b,c)},showNotice:function(b,e){if(tdcNotice._isInitialized){var a="",c="",m=!1,g=5E3;if("undefined"!==typeof e){if("undefined"!==typeof e.type)switch(e.type){case "error":a="tdc-notice-error";m=!0;break;case "info":a="tdc-notice-info"}"undefined"!==typeof e.hasClose&&!0===e.hasClose&&
(c='<div class="tdc-close-notice"></div>');"undefined"!==typeof e.timeout&&(g=e.timeout)}var d=f('<div class="tdc-notice '+a+'"><span class="tdc-msg-tag"></span>'+b+c+"</div>");tdcNotice.$_noticeWrapper.append(d);setTimeout(function(){d.addClass("tdc-notice-in")},100);if(m)throw tdcNotice._errorNotices.push(d),b;setTimeout(function(){d.removeClass("tdc-notice-in")},g-1E3);setTimeout(function(){d.css("margin-top","-"+d.outerHeight()+"px")},g-500);setTimeout(function(){d.remove()},g)}},removeAll:function(){tdcNotice._errorNotices.forEach(function(b,
e){b.remove()})},init:function(){tdcNotice._isInitialized||(tdcNotice.$_noticeWrapper=f('<div class="tdc-notice-wrapper"></div>'),tdcNotice.$_noticeWrapper.on("click",".tdc-close-notice",function(b){f(this).closest(".tdc-notice").remove()}),f("#tdc-live-iframe-wrapper").append(tdcNotice.$_noticeWrapper),tdcNotice._isInitialized=!0)}};tdcNotice.init()})(jQuery);var tdcDebug;
...
tdcRecycle.$_undo.on("click",tdcRecycle._undo),tdcRecycle.$_redo.on("click",tdcRecycle._redo),tdcRecycle.takeSnapshot(),document.body.addEventListener("keydown",tdcRecycle._checkKeyDown,!0),document.getElementById("tdc-live-iframe").contentDocument.addEventListener("keydown",tdcRecycle._checkKeyDown,!0),tdcRecycle._isInitialized=!0)},_getIndexPath:function(b){var a="";if(!d.isUndefined(b)){a=b.get("parentModel");if(d.isUndefined(a))return"tdc_zone"===b.get("tag")?tdcIFrameData.tdcTopCollection.indexOf(b):
"";var c=a.get("childCollection");a=tdcRecycle._getIndexPath(a)+"_"+c.models.indexOf(b)}return a},_undo:function(b){1!==tdcRecycle._items.length&&(tdcRecycle._currentIndex++,tdcRecycle._currentIndex>tdcRecycle._items.length-1?tdcRecycle._currentIndex=tdcRecycle._items.length-1:(tdcRecycle._currentIndex===tdcRecycle._items.length-1&&tdcRecycle.$_undo.removeClass("tdc-restore-active"),b=tdcRecycle.$_restoreContent.find(".tdc-snapshot:eq("+tdcRecycle._currentIndex+")"),b.length&&b.trigger("click"),1<
tdcRecycle._items.length&&tdcRecycle.$_redo.addClass("tdc-restore-active")))},_redo:function(b){1!==tdcRecycle._items.length&&(tdcRecycle._currentIndex--,0>tdcRecycle._currentIndex?tdcRecycle._currentIndex=0:(0===tdcRecycle._currentIndex&&tdcRecycle.$_redo.removeClass("tdc-restore-active"),b=tdcRecycle.$_restoreContent.find(".tdc-snapshot:eq("+tdcRecycle._currentIndex+")"),b.length&&b.trigger("click"),1<tdcRecycle._items.length&&tdcRecycle.$_undo.addClass("tdc-restore-active")))},_checkKeyDown:function(b){if(90===
b.keyCode&&b.ctrlKey){if(b.shiftKey)return tdcRecycle._redo(),!1;b.preventDefault();tdcRecycle._undo();return!1}if(83===b.keyCode&&b.ctrlKey)return b.preventDefault(),tdcAdminWrapperUI.savePostHandler(b),!1},takeSnapshot:function(e){var a={error:b,getShortcode:""};tdcIFrameData.getShortcodeFromData(a);d.isUndefined(a.error)||tdcDebug.log(a.error);if(!d.isUndefined(a.getShortcode)&&""!==a.getShortcode){var c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcSavePost.getHeaderTemplateData()));if(!tdcRecycle._isLastSnapshot(a.getShortcode,
c)){tdcRecycle._currentIndex=0;d.isUndefined(e)&&(e="Restore point");var m=new Date;e=new tdcRecycle.item(m.getTime(),e,a.getShortcode,c);a=tdcRecycle._getIndexPath(tdcSidebar.getCurrentModel());tdcRecycle._maxItems===tdcRecycle._items.length&&(tdcRecycle._items.splice(tdcRecycle._items.length-1,1),tdcRecycle.$_restoreContent.find(".tdc-snapshot:last").remove());tdcRecycle._items.push(e);c=tdcRecycle.$_restoreContent.find(".tdc-snapshot-active");c.length&&(c.prevAll().each(function(a,c){tdcRecycle._items.splice(0,
1);f(c).remove()}),c.removeClass("tdc-snapshot-active"));tdcRecycle.$_restoreContent.prepend('<div class="tdc-snapshot tdc-snapshot-active"><div style="width: 150px; float: left">'+m.toLocaleDateString()+" "+m.toLocaleTimeString()+'</div><div style="width: 350px; float: left">Before '+e.description+'</div><div class="tdc-snapshot-shortcode" style="display: none" data-index_path="'+a+'">'+tdcUtil.b64EncodeUnicode(e.shortcode)+'</div><div class="tdc-snapshot-header" style="display: none">'+e.headerTemplateData+
"</div></div>");1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"))}}},_isLastSnapshot:function(b,a){return 0===tdcRecycle._currentIndex&&tdcRecycle._items.length&&tdcRecycle._items[tdcRecycle._items.length-1].shortcode===b&&tdcRecycle._items[tdcRecycle._items.length-1].headerTemplateData===a?!0:!1},_cloneCurrentItem:function(){if(0!==tdcRecycle._currentIndex){var b=tdcRecycle._items.find(function(a,c,b){return c===tdcRecycle._items.length-
1-tdcRecycle._currentIndex});if(!d.isUndefined(b)){var a=new Date,c=new tdcRecycle.item(a.getTime(),b.description+" - restored",b.shortcode,b.headerTemplateData),m=tdcRecycle._getIndexPath(tdcSidebar.getCurrentModel());tdcRecycle._maxItems===tdcRecycle._items.length&&(tdcRecycle._items.splice(tdcRecycle._items.length-1,1),tdcRecycle.$_restoreContent.find(".tdc-snapshot:last").remove());tdcRecycle._items.push(c);tdcRecycle.$_restoreContent.prepend('<div class="tdc-snapshot"><div style="width: 150px; float: left">'+
a.toLocaleDateString()+" "+a.toLocaleTimeString()+'</div><div style="width: 350px; float: left">Before '+c.description+'</div><div class="tdc-snapshot-shortcode" style="display: none" data-index_path="'+m+'">'+tdcUtil.b64EncodeUnicode(c.shortcode)+'</div><div class="tdc-snapshot-header" style="display: none" data-index_path="'+m+'">'+tdcUtil.b64EncodeUnicode(c.headerTemplateData)+"</div></div>");1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"));
return b.shortcode}}},clearJsItems:function(){var b=tdcAdminIFrameUI.getIframeWindow();if("undefined"!==typeof b.tdcComposerBlocksApi)for(;b.tdcComposerBlocksApi.items.length;)b.tdcComposerBlocksApi.deleteItem(b.tdcComposerBlocksApi.items[b.tdcComposerBlocksApi.items.length-1].blockUid);if("undefined"!==typeof b.tdPullDown)for(;b.tdPullDown.items.length;)b.tdPullDown.deleteItem(b.tdPullDown.items[b.tdPullDown.items.length-1].blockUid);if("undefined"!==typeof b.tdAnimationSprite)for(;b.tdAnimationSprite.items.length;)b.tdAnimationSprite.deleteItem(b.tdAnimationSprite.items[b.tdAnimationSprite.items.length-
...
(function(f,d,b,e){tdcState={_headerTemplateId:"",_headerTemplateContent:"",_isGlobalTemplate:!1,_isNoHeader:!1,init:function(a,c,b,e){tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b&&tdcState.setGlobalTemplate();e&&tdcState.setNoHeader()},setHeaderTemplateId:function(a){tdcState._headerTemplateId=a},getHeaderTemplateId:function(){return tdcState._headerTemplateId},setHeaderTemplateContent:function(a){tdcState._headerTemplateContent=a},getHeaderTemplateContent:function(){return tdcState._headerTemplateContent},
setGlobalTemplate:function(){tdcState._isGlobalTemplate=!0},unsetGlobalTemplate:function(){tdcState._isGlobalTemplate=!1},isGlobalTemplate:function(){return tdcState._isGlobalTemplate},setNoHeader:function(){tdcState._isNoHeader=!0},unsetNoHeader:function(){tdcState._isNoHeader=!1},isNoHeader:function(){return tdcState._isNoHeader}};f=window.tdcPostSettings.headerTemplateId;d=window.tdcPostSettings.headerTemplateContent;e=b=!1;""===f?(f=window.tdcAdminSettings.headerTemplateId.toString().replace("tdb_template_",
""),d=window.tdcAdminSettings.headerTemplateContent,b=!0):"no_header"===f&&(e=!0);tdcState.init(f,d,b,e)})(jQuery,Backbone,_);var tdcSavePost;
(function(f,d,b,e){tdcSavePost={content:e,savePost:function(){if(b.isUndefined(window.tdcPostSettings.tdbTemplateType)||"header"!==window.tdcPostSettings.tdbTemplateType){var a={error:e,getShortcode:""};tdcIFrameData.getShortcodeFromData(a);b.isUndefined(a.error)||tdcDebug.log(a.error);b.isUndefined(a.getShortcode)||b.isUndefined(window.tdcPostSettings)||(tdcSavePost.content=a.getShortcode,tdcLivePanel.$tdcAction.val("tdc_ajax_save_post"),tdcLivePanel.$tdcContent.val(tdcSavePost.content),f.ajax({timeout:1E4,
type:"POST",url:tdcUtil.getRestEndPoint("td-composer/save_post","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce);tdcLivePanelMenuSettings.saveMenuSettings()},data:tdcLivePanel.$panel.serialize()}).done(function(a,e,g){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,
!0,!1):(new tdcNotice.notice("Content Successfully Saved!",!1,!0),0!==tdcLivePanel.$tdbPostSettings.length&&!0===tdcLivePanel.$tdbPostSettings.data("changed")&&new tdcNotice.notice("Single Templates Post Settings Successfully Saved!",!1,!0)),tdcMain.resetContentModified(),tdcLivePanel.$tdbPostSettings.data("changed",!1))}).fail(function(a,b,e){}))}},updateHeaderTemplate:function(){var a=tdcSavePost.getHeaderTemplateData();f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/update_header_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"update_header_template",tdc_header_template_id:a.tdc_header_template_id,tdc_header_template_content:a.tdc_header_template_content,tdc_assoc_header_template:a.tdc_assoc_header_template,tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,e,g){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);
f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,b,e){})},getHeaderTemplateData:function(){var a=tdcState.getHeaderTemplateId(),c="",b={};""!==a&&"no_header"!==a&&(c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcIFrameData.getHeaderShortcodeFromData())));
tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b.tdc_header_template_id=a;b.tdc_header_template_content=c;b.tdc_assoc_header_template=tdcState.isGlobalTemplate()?"":!0;return b},cloudLoadHeaderTemplate:function(a,c,e,g){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g},b.isUndefined(e)||(g.tdc_header_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_header_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:g}).done(function(e,m,g){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"header_template_id")&&(tdcState.setHeaderTemplateId(e.header_template_id),tdcState.unsetGlobalTemplate()),tdcSidebar.updateHeaderTemplates(),tdcIFrameData.setHeaderTemplate(a,c))}).fail(function(a,c,b){}))},saveMobileMenu:function(a,c){f.ajax({timeout:1E4,
type:"POST",url:tdcUtil.getRestEndPoint("td-composer/save_header_mobile_menu","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{template_id:a,menu_id:c}}).done(function(a,e,d){"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):window.tdcPostSettings.mobileMenuId=c)}).fail(function(a,c,b){})}}})(jQuery,Backbone,_);var tdcShortcodeParser={};
...
f("body").append(tdcAdminWrapperUI.$placeholder);tdcAdminWrapperUI.$savePage=f(".tdc-save-page");tdcAdminWrapperUI.$savePage.on("click",tdcAdminWrapperUI.savePostHandler);f(document).bind("click",function(b){f("#tdc-context-menu").hide()})},savePostHandler:function(b){tdcAdminWrapperUI.$savePage.hasClass("tdc-saving-loader")||(tdcAdminWrapperUI.$savePage.addClass("tdc-saving-loader"),tdcSavePost.savePost(),"Newspaper"===window.tdcAdminSettings.themeName&&tdcSavePost.updateHeaderTemplate())},setHelperClass:function(b){tdcAdminWrapperUI._helperClass!==
b&&(tdcAdminWrapperUI._helperClass=b,tdcAdminWrapperUI.$helper.addClass(b))},getHelperClass:function(){return tdcAdminWrapperUI._helperClass},clearHelperClass:function(){tdcAdminWrapperUI._helperClass=""}};tdcAdminWrapperUI.init()})(jQuery);var tdcOperationUI;
...
v){var z="",x=a.find(".td_block_inner");x.length&&(z=x.attr("id"));if(!d&&!b.isUndefined(w)&&w.length){var A=w.children();x=A.index(a);var y=A.index(m);if(c!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(x-y))return;if(k||n||p||t||v){if((k||n||t)&&c===tdcAdminWrapperUI.$recycle){m="Deleting ";tdConfirm.showModal(n?m+"inner row":t?m+"row":m+"element",tdcOperationUI,function(){if((-1===y&&1===A.length||2===A.length&&-1!==y)&&(!t||1!==tdcIFrameData.tdcRows.length)){var c="";B=a.closest(".tdc-inner-column");
...
wasElementDragged:k,wasInnerColumnDragged:h,wasInnerRowDragged:n,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:z,sourceColParam:g});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);tdcOperationUI.setCurrentElementOver(e);tb_remove()},e,"Are you sure you want to delete this element?");return}if(-1===y&&1===A.length||2===A.length&&-1!==y){c="";var B=a.closest(".tdc-inner-column");if(B.length)c=
...
wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,draggedBlockUid:z,sourceColParam:g})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}},_copyElement:function(a){var c=tdcOperationUI.getCurrentElementOver(),m=tdcAdminWrapperUI.$placeholder;if(!b.isUndefined(c)&&!b.isUndefined(m)){var g=tdcUtil.getStorageItem("copyShortcodeType"),d=tdcUtil.getStorageItem("copyShortcodeAttrs"),k=tdcUtil.getStorageItem("copySourceCol"),h=tdcUtil.getStorageItem("copyShortcode"),
...
b.isUndefined(m.indexPath)||tdcSidebarPanel.showShortcodeFromPath(m.indexPath)});tdcIFrameData.rebuildZone(a,g[a],c,m)}});"header"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateHeaderTemplate()}},_callbackShortcodeRender:function(a){b.isUndefined(a)||b.isUndefined(a.lateCallback)||(b.isUndefined(a.lateCallbackContext)?setTimeout(function(){a.lateCallback.call(this)},2E3):setTimeout(function(){a.lateCallback.call(a.lateCallbackContext)},2E3))},_defineStructuredData:function(){tdcIFrameData._isInitialized||
(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,d,g,l){var m=this,h={error:e,getShortcode:""};b.isUndefined(g)?tdcIFrameData._checkModelData(m,h):tdcIFrameData._checkModelData(g,h);if(!b.isUndefined(h.getShortcode)){var f=new tdcJobManager.job;f.shortcode=h.getShortcode;f.columns=a;f.blockUid=c;f.tries=0;f.success_callback=function(a){tdcDebug.log(a);var k=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(g)&&tdcIFrameData.deleteCallback(m);!1===d?m.set("blockUid",a.blockUid):
m.set("blockUid",e);b.has(a,"replyHtml")&&(m.set("bindNewContent",d),m.set("shortcode",f.shortcode),m.set("html",a.replyHtml,l));b.has(a,"replyJsForEval")&&(k.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval));b.isUndefined(l)||b.isUndefined(l.earlyCallback)||(b.isUndefined(l.earlyCallbackContext)?l.earlyCallback.call(this):l.earlyCallback.call(l.earlyCallbackContext))};b.isUndefined(l)||b.isUndefined(l.is_snapshot)||!0!==l.is_snapshot||(f.is_snapshot=!0);f.error_callback=
function(a,c){tdcDebug.log(c);tdcDebug.log(a);f.tries||(f.tries++,tdcJobManager.addJob(f))};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(f)}h={error:e,getShortcode:""};tdcIFrameData._checkModelData(m,h);b.isUndefined(h.error)||tdcDebug.log(h.error);h={error:e,getShortcode:""};b.isUndefined(m.get("parentModel"))||(tdcIFrameData._checkModelData(m.get("parentModel"),h),b.isUndefined(h.error)||tdcDebug.log(h.error))}}),tdcIFrameData.TdcCollection=
Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcTopCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=Backbone.View.extend({initialize:function(){this.listenTo(this.model,"change:current",this.changeCurrent);this.listenTo(this.model,"change:html",this.customRender);this.listenTo(this.model,"remove",this.customRemove)},changeCurrent:function(a,c,e){this.model.has("current")&&!b.isUndefined(this.model.get("current"))&&!0===this.model.get("current")?
(this.$el.addClass("tdc-element-selected"),tdcOperationUI.activeElementOver()):(this.$el.removeClass("tdc-element-selected"),tdcOperationUI.inactiveElementOver());this.model.set("cssWidth",this.$el.width())},customRemove:function(a,c,b){this.$el.hasClass("tdc-rows")?this.$el.html(""):this.remove()},customRender:function(a,c,d){tdcDebug.log("customRender - Rendering our model");if(this.model.has("html")&&!b.isUndefined(this.model.get("html"))){this.$el.removeClass("tdc-dropped");this.$el.removeClass("tdc-changed");
this.$el.html(this.model.get("html"));setTimeout(function(){"undefined"!==typeof tdcIFrameData.iframeContents.lastMouseEvent&&tdcMaskUI.repositionMask(tdcIFrameData.iframeContents.lastMouseEvent)},100);c=this.$el.find(".td_block_wrap");c.length&&0===parseInt(c.outerHeight(!0))&&c.addClass("tdc-block-empty");if(this.model.has("bindNewContent")&&!0===this.model.get("bindNewContent"))if(this.model.set("bindNewContent",!1,{silent:!0}),this.$el.hasClass("tdc-element-inner-row-temp")){if(a.has("templateContent")){c=
...
a=a.filter(function(a){return 0>["vc_row","vc_column","vc_row_inner","vc_column_inner"].indexOf(a)});a={0:["vc_row"],1:["vc_column"],2:["vc_row_inner"],3:["vc_column_inner"],4:a};tdcIFrameData._shortcodeParserSettingsClone=a;tdcShortcodeParser.init(a);tdcIFrameData._postOriginalContentJSON=tdcShortcodeParser.parse(0,tdcUtil.b64DecodeUnicode(window.tdcPostSettings.postContent))}return tdcIFrameData._postOriginalContentJSON},_getHeaderOriginalContentJSON:function(a){var c=Object.keys(window.tdcAdminSettings.mappedShortcodes);
...
'")')})});f.tdc_css=window.btoa(JSON.stringify(l))}})}),k=f,a.set("attrs",k));if("td_block_text_with_title"===l||"vc_column_text"===l||"vc_raw_html"===l)if(b.map(k,function(a,c){"content"!==c&&(h+=" "+c+'="'+a+'"')}),b.has(k,"content"))if("vc_raw_html"===l)h="["+l+h+"]"+b.unescape(k.content)+"[/"+l+"]";else try{var p=tdcUtil.b64DecodeUnicode(k.content);h="["+l+h+"]"+p+"[/"+l+"]"}catch(q){h="["+l+h+"]"+b.unescape(k.content)+"[/"+l+"]"}else h="["+l+h+"]";else switch(b.map(k,function(a,c){h+=" "+c+'="'+
a+'"'}),d){case "single":h="["+l+h+"]";break;case "closed":p="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(p=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=e);h="["+l+h+"]"+p+"[/"+l+"]";break;case "template":h="vc_column"===l||"vc_column_inner"===l?"["+l+h+"]"+c.template+"[/"+l+"]":c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=h;0===c.deepLevel&&(c.getShortcode+=h)}}else c.error="Not zones as the first elements!"}},
...
!0,!1);var l=tdcIFrameData._getDestinationCol(a.$refEl);g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);var k=g.get("childCollection");var h={},f=c.data("start-values"),p;"undefined"!==typeof f&&(f=JSON.parse(tdcUtil.b64DecodeUnicode(f)),"undefined"!==typeof f&&(b.isArray(f)&&f.length?(h=f[0],1<f.length&&(p=f)):h=f));f=c.data("shortcodeName");h=new tdcIFrameData.TdcModel({content:"",attrs:h,tag:f,type:"single",level:4,parentModel:g});new tdcIFrameData.TdcLiveView({model:h,
el:c[0]});b.isUndefined(p)||h.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(h.get("tag")+" : sidebar element added");c.data("model_id",h.cid);k.add(h,{at:d});h.set("parentModel",g);h.getShortcodeRender(l,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1),l=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),k=g.get("childCollection"),f=c.data("templateContent"),b.isUndefined(f)?(g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:g,el:c[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:4,parentModel:g}),c.data("model_id",g.cid),k.add(g,
{at:d}),c=new tdcIFrameData.TdcCollection,c.add(h),g.set("childCollection",c),c=new tdcIFrameData.TdcCollection,h.set("childCollection",c)):(g=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:g,el:c[0]}),c.data("model_id",g.cid),k.add(g,{at:d})),g.getShortcodeRender(l,a.draggedBlockUid,!0);else if(a.wasTempRowDragged){tdcRecycle.takeSnapshot("Sidebar row added");f=c.data("templateContent");g=tdcIFrameData._getDestinationModel(a.$refEl,
[".tdc-zone"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);k=g.get("childCollection");if(b.isUndefined(f)){var q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:q,el:c[0]});h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});
c.data("model_id",q.cid);d=c.prevAll(".tdc-row").length;k.add(q,{at:d});k=new tdcIFrameData.TdcCollection;k.add(h);q.set("childCollection",k);d=new tdcIFrameData.TdcCollection;h.set("childCollection",d);a.wasElementWithRowDragged&&(k={},g={},f=c.data("start-values"),l=c.data("row-start-values"),"undefined"!==typeof l&&(g=JSON.parse(window.atob(l))),q.set({attrs:g}),"undefined"!==typeof f&&(k=JSON.parse(window.atob(f)),b.isArray(k)&&(k=k[0])),f=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",
attrs:k,tag:f,type:"single",level:3,parentModel:h}),d.add(c),h=new tdcIFrameData.TdcCollection,c.set("childCollection",h))}else q=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row",type:"template",level:1,parentModel:g}),new tdcIFrameData.TdcLiveView({model:q,el:c[0]}),d=c.prevAll(".tdc-row").length,c.data("model_id",q.cid),b.isUndefined(g)||(k.add(q,{at:d}),g.set("childCollection",k),q.set("childCollection",new tdcIFrameData.TdcCollection));q.getShortcodeRender(1,a.draggedBlockUid,
!0)}else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),f=c.data("templateContent"),!b.isUndefined(f)){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}h=tdcIFrameData.getModel(c);if(b.isUndefined(h)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}h.set("templateContent",f);h.set("type","template");l=tdcIFrameData._getDestinationCol(a.$refEl);h.getShortcodeRender(l,
a.draggedBlockUid,!0)}}else{if(a.wasInnerColumnDragged&&(tdcRecycle.takeSnapshot("Inner column copied"),f=c.data("templateContent"),!b.isUndefined(f))){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}h=tdcIFrameData.getModel(c);if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}h.set("templateContent",f);h.set("type","template");c=tdcIFrameData._getDestinationCol(a.$refEl);
h.getShortcodeRender(c,a.draggedBlockUid,!0)}}else{h=c.data("model_id");if(b.isUndefined(h)){new tdcNotice.notice("changeData Error: Element model id is not in $refEl data!",!0,!1);return}h=tdcIFrameData.getModel(h);if(b.isUndefined(h)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(h);
tdcRecycle.takeSnapshot(h.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(h.get("tag")+" : element moved");p=h.get("parentModel");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);p.cid===g.cid?(l=p.get("childCollection"),l.remove(h,{silent:!0}),l.add(h,{at:d})):(l=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",
new tdcIFrameData.TdcCollection),k=g.get("childCollection"),tdcIFrameData.removeModel(h,!1,{silent:!0}),k.add(h,{at:d}),h.set("parentModel",g),a.sourceColParam!==l&&h.getShortcodeRender(l,a.draggedBlockUid,!0));tdcRecycle.takeSnapshot(h.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");tdcIFrameData.removeModel(h);tdcRecycle.takeSnapshot("Inner row recycled");
return}tdcRecycle.takeSnapshot("Inner row moved");p=h.get("parentModel");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(p.cid===g.cid)l=p.get("childCollection"),l.remove(h,{silent:!0}),l.add(h,{at:d});else{g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);k=g.get("childCollection");tdcIFrameData.removeModel(h,!0,{silent:!0});k.add(h,{at:d});
h.set("parentModel",g);a=p.get("attrs");d=g.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":l="13";break;case "2/3":l="23"}if(b.has(d,"width"))switch(d.width){case "1/3":f="13";break;case "2/3":f="23"}b.isUndefined(l)&&(l="11");b.isUndefined(f)&&(f="11");if(l!==f&&(a=h.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");d="11";k=1;switch(f){case "11":switch(a){case "11":d="11";break;case "23_13":d="23_13";break;case "13_23":d=
"13_23";break;case "12_12":d="13_13_13";break;case "13_13_13":d="13_13_13"}k=3;break;case "13":switch(a){case "11":d="11";break;case "23_13":d="11";break;case "13_23":d="11";break;case "12_12":d="11";break;case "13_13_13":d="11"}break;case "23":switch(a){case "11":d="12_12";break;case "23_13":d="12_12";break;case "13_23":d="12_12";break;case "12_12":d="12_12";break;case "13_13_13":d="12_12"}k=2}if(a!==d||l!==f)tdcIFrameData.changeInnerRowModel(h,a,d),h.getShortcodeRender(k,null,!0)}a=tdcOperationUI.inZone(c);
d=tdcOperationUI.inRow(c);k=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(k)||b.isUndefined(c)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d,$currentColumn:k,$currentInnerRow:c},!0)}tdcRecycle.takeSnapshot(h.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),p=h.get("parentModel"),l=p.get("childCollection"),l.remove(h,{silent:!0}),l.add(h,{at:d}),a.wasColumnDragged?(a=tdcOperationUI.inZone(c),
d=tdcOperationUI.inRow(c),b.isUndefined(d)||b.isUndefined(a)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d}),tdcRecycle.takeSnapshot("Column moved")):a.wasInnerColumnDragged&&(a=tdcOperationUI.inZone(c),d=tdcOperationUI.inRow(c),k=tdcOperationUI.inColumn(c),c=tdcOperationUI.inInnerRow(c),b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(k)||b.isUndefined(c)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d,$currentColumn:k,$currentInnerRow:c}),tdcRecycle.takeSnapshot("Inner-column moved"));
else if(a.wasRowDragged){tdcDebug.log("case 4");p=h.get("parentModel");f=p.get("blockUid");l=p.get("childCollection");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){l.remove(h);tdcDebug.log("row recycled");tdcRecycle.takeSnapshot("Row recycled");l.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+f+" .tdc_zone")[0]}),h=new tdcIFrameData.TdcModel({content:"",
...
l.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+f+" .tdc_zone")[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),l.add(q,{at:0}),k=new tdcIFrameData.TdcCollection,k.add(h),q.set("childCollection",k),h.set("childCollection",new tdcIFrameData.TdcCollection),setTimeout(function(){q.getShortcodeRender(1,
...
(c=a.find(".wpb_wrapper"),c.length&&c.append('<div class="tdc-elements"></div>'));a.find(".tdc-elements:empty").each(function(a,c){var b="",e=f(c);e.closest(".tdc-inner-column").length?b=" tdc-element-inner-column":e.closest(".tdc-column").length&&(b=" tdc-element-column");b=f('<div class="'+tdcOperationUI._emptyElementClass+b+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(b);e.append(b)})};window.addInnerRowWrappers=function(a){var c=a.find(".td_block_wrap");
...
window.addSidebarWrappers=function(a){a.find(".td-main-sidebar").wrap('<div class="tdc-sidebar-content"></div>')};window.checkTdBlockWrap=function(a){a.each(function(a,c){var b=f(c);0===parseInt(b.height())?b.addClass("tdc-block-empty"):b.removeClass("tdc-block-empty")})};var a=window.tdcPostSettings.postMetaVcJsStatus,c=window.tdcPostSettings.postContent;"1"!==window.tdcPostSettings.postMetaDirtyContent&&"true"!==a||""===c||new tdcNotice.showNotice("The current content hasn't been created by TagDiv Composer!",
{type:"info"});tdcAdminIFrameUI.checkIframe(tdcAdminIFrameUI._$liveIframe)},loadIframe:function(){(tdDetect.isIe8||tdDetect.isIe9||tdDetect.isIe10)&&tdConfirm.showModalOk("Browser Information","TagDiv Composer does not work with Internet Explorer 8, 9, 10",function(){tb_remove()});var a=f(this).contents();"header"===window.tdcPostSettings.tdbTemplateType&&a.find(".tdc-content-wrap").html("");tdcAdminIFrameUI.initContent(a);tdcAdminIFrameUI._liveIframeWindowObject=f(this).get(0).contentWindow;var c=
f('<div id="tdc-recycle" class="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');a.find("body").prepend(c);tdcAdminWrapperUI.$recycle=c;tdcIFrameData._postOriginalContentJSON=e;window.addWrappers(a,".td-main-content-wrap","tdc_content");window.addWrappers(a,".td-header-desktop-wrap","tdc_header_desktop");window.addWrappers(a,".td-header-desktop-sticky-wrap","tdc_header_desktop_sticky");window.addWrappers(a,".td-header-mobile-wrap","tdc_header_mobile");window.addWrappers(a,
".td-header-mobile-sticky-wrap","tdc_header_mobile_sticky");tdcIFrameData.init(a,!0);tdcOperationUI.init(a,!0);a.on("click","a",function(a){a.preventDefault();"undefined"!==this.href&&window.open(this.href,"_blank")});a[0].addEventListener("mousedown",function(a){1!==a.which&&a.stopPropagation()},!0);a[0].addEventListener("mousemove",function(c){a.lastMouseEvent=c},!0);a.on("click",function(a){tdcContextMenu.hide()});a.on("scroll",function(a){tdcContextMenu.hide()});a.bind("contextmenu",function(a){if(!a.ctrlKey){a.preventDefault();
var c=a.pageX,b=a.pageY,e=0,d=f("#tdc-context-menu"),m=d.width();d=d.height();tdcMain.getSidebarInline()&&(e=tdcSidebar.$_sidebar.width());c+m+e>tdcWindowFrame.$_window.width()&&(c=tdcWindowFrame.$_window.width()-m-e);b+d>tdcAdminIFrameUI.getIframeWindow().scrollY+tdcWindowFrame.$_window.height()&&(b=tdcAdminIFrameUI.getIframeWindow().scrollY+tdcWindowFrame.$_window.height()-d);e=tdcAdminIFrameUI.getLiveIframe();e=(e.parent().width()-e.width())/2;f(a.target).trigger(f.Event("contextmousedown",{pageX:c+
e,pageY:b}))}})},checkIframe:function(a){if(b.isUndefined(a)){a=window.tdcPostSettings.postUrl;var c="";!1!==window.tdcPostSettings.tdbLoadDataFromId&&!1!==window.tdcPostSettings.tdbTemplateType?c="&tdbLoadDataFromId="+window.tdcPostSettings.tdbLoadDataFromId+"&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType:!1!==window.tdcPostSettings.tdbTemplateType&&(c="&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType);a=0>a.indexOf("?")?a+("?td_action=tdc_edit&post_id="+window.tdcPostSettings.postId+
c):a+("&td_action=tdc_edit&post_id="+window.tdcPostSettings.postId+c);a=f('<iframe id="tdc-live-iframe" name="tdc-live-iframe" src="'+a+'" scrolling="auto" style="width: 100%; height: 100%" class="tdc-responsive-all"></iframe>').load(tdcAdminIFrameUI.loadIframe);f("#tdc-live-iframe-wrapper").append(a)}else{var d=a;c=d.contents();tdcAdminIFrameUI.initContent(c);tdcAdminIFrameUI._liveIframeWindowObject=d.get(0).contentWindow;d=f('<div id="tdc-recycle" class="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');
tdcDebug.log(tdcIFrameData.tdcTopCollection.models);c.find("body").prepend(d);tdcAdminWrapperUI.$recycle=d;tdcIFrameData._postOriginalContentJSON=e;window.addWrappers(c,".td-main-content-wrap","tdc_content");window.addWrappers(c,".td-header-desktop-wrap","tdc_header_desktop");window.addWrappers(c,".td-header-desktop-sticky-wrap","tdc_header_desktop_sticky");window.addWrappers(c,".td-header-mobile-wrap","tdc_header_mobile");window.addWrappers(c,".td-header-mobile-sticky-wrap","tdc_header_mobile_sticky");
tdcIFrameData.init(c,!0);tdcOperationUI.init(c,!0);c.find("a").each(function(a,c){c.setAttribute("target","_blank")});a.removeClass("tdc-live-iframe");a.removeClass("tdc-live-iframe-temp")}tdcAdminIFrameUI._$liveIframe=a}}})(jQuery,Backbone,_);var tdcMain={};
...
e+'" data-mapped_parameter_name="'+c+'"></iframe>');b.show();tdcWindowFrame.setWindowFrame(b)});d.on("click","#tdc-wpeditor .tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-wpeditor").hide()});d.on("click","#tdc-zone .tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-zone").hide()});d.on("click",".tdc-sidebar-shortcode-row",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var e={error:f,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,
e);_.isUndefined(e.getShortcode)||console.log(e.getShortcode)});d.on("click",".tdc-sidebar-current-styles-settings",function(b){b=tdcSidebarPanel.getCurrentStyleSettings(b);if(!_.isUndefined(b)){var e="",a;for(a in b)e+='"'+a+'" => "'+b[a]+'",\n';console.log(e)}});d.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",htmlInfoContent:"This will clear all values for this font group settings.",textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();
var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),d=c.get("attrs");d=_.clone(d);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),f="",k=0;k<g.length;k++){var h=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[k]+":first");if(h.length){var n=h.find('[data-model_id="'+a+'"]');n.length&&(n.val(""),n.data("responsive",""),h.removeClass("tdc-css-inherited"),f=h.find(".tdc-inherit"),f.length&&f.hide(),f=n.data("placeholder"),
"undefined"!==typeof f&&n.attr("placeholder",f),f=n.data("param_name"),delete d[f],n=n.attr("name"),tdcSidebarPanel.deleteResponsiveValues(n))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,f,"","")}})});d.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var e=b.data("model_id");e=tdcIFrameData.getModel(e).get("attrs");var a=b.data("param_name").replace("font_settings",""),c="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),d={};
_.each(e,function(b,e,f){if(0===e.indexOf(a))for(f=0;f<c.length;f++)if(0<e.indexOf(c[f])){d[c[f]]=b;break}});_.isEmpty(d)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var a=jQuery("#TB_ajaxContent"),c=a.find(".info");a=a.find("input").val().trim();if(""===
a)c.html("Please enter a font name");else{if("undefined"===typeof window.tdcAdminSettings.tdcSavings||""===window.tdcAdminSettings.tdcSavings)window.tdcAdminSettings.tdcSavings={};"undefined"===typeof window.tdcAdminSettings.tdcSavings.fonts&&(window.tdcAdminSettings.tdcSavings.fonts=[]);-1===_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:a})?(c.html("Saving..."),window.tdcAdminSettings.tdcSavings.fonts.push({name:a,value:window.btoa(JSON.stringify(d))}),tdcUtil.updateTdcSavings(window,
function(){jQuery("#TB_ajaxContent").find(".info").html("Font has been saved!");setTimeout(function(){tb_remove()},500)})):c.html("Font name already exists! Choose another one")}}})});d.on("click",".tdc-sidebar-font-load",function(){var b=jQuery(this),e=b.closest(".tdc-property-wrap"),a=b.data("model_id"),c=b.data("param_name");if(""!==window.tdcAdminSettings.tdcSavings&&("undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts||"undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts)){var d=
jQuery("#tdc-font-list");d.length||(d=tdcSidebar.buildFontList(a,c));d.html("");"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts&&(jQuery('<div class="tdc-font-list-header"><span>Saved fonts</span></div>').appendTo(d),_.map(window.tdcAdminSettings.tdcSavings.fonts,function(b){jQuery('<div class="tdc-font-settings" data-value="'+b.value+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(d)}));
if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(d);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var f=window.tdcAdminSettings.tdcSavings.recentFonts[g],k=b[f];_.isUndefined(k)||jQuery('<div class="tdc-recent-font-settings" data-value="'+f+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+
k+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(d)}}e.after(d);d.toggle()}});d.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();var d=jQuery(this).closest(".tdc-font-settings");b=d.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:b});window.tdcAdminSettings.tdcSavings.fonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){d.remove()})});d.on("click",".tdc-recent-font-delete",function(b){b.stopImmediatePropagation();var d=jQuery(this).closest(".tdc-recent-font-settings");
b=d.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.recentFonts,{name:b});window.tdcAdminSettings.tdcSavings.recentFonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){d.remove()})});d.on("click",".tdc-font-settings",function(){var b=jQuery(this),d=b.data("value");d=JSON.parse(window.atob(d));var a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs"),f=b.data("param_name").replace("font_settings",""),g="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" ");
_.each(d,function(a,b,d){-1!==_.indexOf(g,b)&&(c[f+b]=a)});a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});d.on("click",".tdc-recent-font-settings",function(){var b=jQuery(this),d=b.data("value"),a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs");b=b.data("param_name").replace("font_settings","");c[b+"font_family"]=d;a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)})},getCurrentStyleSettings:function(d,b){if(_.isUndefined(b)){var e=jQuery(d.currentTarget).data("model_id");
b=tdcIFrameData.getModel(e);e={error:f};_.isUndefined(b)||tdcIFrameData._checkModelData(b,e)}var a=b.get("tag");e=b.get("attrs");e=_.clone(e);if(!_.isUndefined(e)){var c={},m={};for(g in e)0===g.indexOf("tds_")&&(c[g]=e[g]);var g=window.tdcAdminSettings.mappedShortcodes[a].params;for(a=0;a<g.length;a++){var l=!1,k=g[a];if(0===k.param_name.indexOf("tds_")){for(var h in c)if(k.param_name===h){m[h]=c[h];l=!0;break}l||(m[k.param_name]="")}}for(h in c)switch(g=h.split("-"),g.length){case 2:if(!_.has(m,
h)){c=g[0];g=!1;for(var n in m)if(c===m[n]&&1===n.split("-").length){g=!0;break}if(!g){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],c)){var q=p;break}_.has(m,q)&&""===m[q]&&window.tdcAdminSettings.globalStyle[q]===c&&(g=!0)}g||delete e[h]}break;case 3:c=g[0];a=g[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],c)){q=p;break}g=!1;for(n in m)if(c===m[n]&&n===q+"-"+a){g=!0;break}g||_.has(m,q+
"-"+a)&&""===m[q+"-"+a]&&window.tdcAdminSettings.globalStyle[q]===c&&(g=!0);g||delete e[h]}return e}},showHideTdcPalette:function(d){d=jQuery("#tdc-palette");var b=jQuery(this).closest(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.next("#tdc-palette").length?(d.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),b.after(d),d.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||
tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d=d.find("input.wp-color-picker"),d.tdPaletteColorPicker("open_palette",b),d.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",b))},tdcIconWrapHandler:function(d){var b=jQuery(this),e=jQuery("#tdc-icon-selector");e.length||(e=tdcSidebar.buildIconSelector());
var a=b.closest(".tdc-property-wrap");d=e.find(".tdc-icon-selector-filter");var c=e.find(".tdc-icon-selector-lib"),f=e.find(".tdc-icon-selector-content");c.val("");d.val("");f.children().each(function(){jQuery(this).show()});e.data("model_id",b.data("model_id"));e.data("param_name",b.data("param_name"));e.show();a.after(e);b=e.data("param_name");e=tdcIFrameData.getModel(e.data("model_id")).get("attrs");var g="";_.has(e,b)&&(g=e[b].trim());d.focus();f.find("span").each(function(){var a=jQuery(this),
b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=a.prev();a=a.prev(".tdc-font-separator").data("font_id");c.val(a);c.trigger("change")}else a.removeClass("selected")})},tdcIconRemoveHandler:function(d){var b=jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-icon-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-icon-selected");d.html("");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),
"","")},tdcImageWrapHandler:function(d){var b=jQuery(d.currentTarget);b.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(b);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(d){var a=jQuery("img",d).attr("src"),c="",e="",g="";"undefined"===typeof a?
(a=jQuery(d).attr("src"),c=jQuery(d).attr("class"),e=jQuery(d).attr("height"),g=jQuery(d).attr("width")):(c=jQuery("img",d).attr("class"),e=jQuery("img",d).attr("height"),g=jQuery("img",d).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,
d,f){"success"===d&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",e),b.data("image_width",g),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),d="",f=b.data("model_id"),f=tdcIFrameData.getModel(f),b.hasClass("tdc-no-image-selected")||
(d=c.image_id.toString()),c=f.get("attrs"),c.media_size_image_height=e,c.media_size_image_width=g,f.set("attrs",c),tdcSidebarController.onUpdate(f,b.data("param_name"),"",d)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(d){var b=jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-image-selected");jQuery.removeData(d,"image_link");d.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+
"/assets/images/sidebar/no_img.png'");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),"","")},tdcInheritSelectHandler:function(d){d=jQuery(d.currentTarget);var b=d.closest(".tdc-property-wrap"),e=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");b.hasClass("tdc-property-dropdown-responsive")&&("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),e.find("option:selected").removeAttr("selected").find("option:first").attr("selected",
"selected")):(e.val(a),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(e.attr("name"),tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(e.data("model_id")),e=e.data("param_name"),tdcSidebarController.onUpdate(a,e,"",b));d.hide()},tdcInheritCheckboxHandler:function(d){d=jQuery(d.currentTarget);var b=d.closest(".tdc-property-wrap"),e=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");b.hasClass("tdc-property-checkbox-responsive")&&
("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),e.removeAttr("checked")):(""===a?e.removeAttr("checked"):e.attr("checked","checked"),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(e.attr("name"),tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(e.data("model_id")),e=e.data("param_name"),tdcSidebarController.onUpdate(a,e,"",b));d.hide()},bindPanelToModel:function(d,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==
d.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){var e=window.tdcAdminSettings.mappedShortcodes[d.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=d;for(var a=[],c=0;c<e.params.length;c++){var f=tdcSidebarPanel._defaultGroupName;_.isEmpty(e.params[c].group)||(f=e.params[c].group);a.push(f)}a=_.uniq(a);var g=f="",l=tdcSidebar.getCurrentTabId(),k,h;f+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var n=h=k="";for(c=
0;c<a.length;c++){g=tdcSidebarPanel._fixGroupName(a[c]);var p=tdcUtil.makeSafeForCSS(g);0===c?(k='<a href="#" data-tab-id="td-tab-'+p+'" class="tdc-tab-active" title="'+g+' settings">'+g+"</a>",h='<a href="#" data-tab-id="td-tab-'+p+'" title="'+g+' settings">'+g+"</a>"):_.isUndefined(l)||l!=="td-tab-"+p?n+='<a href="#" data-tab-id="td-tab-'+p+'" title="'+g+' settings">'+g+"</a>":(k=h,n+='<a href="#" data-tab-id="td-tab-'+p+'" class="tdc-tab-active" title="'+g+' settings">'+g+"</a>")}g=p=h=c="";switch(tdcSidebar.currentViewportSettings.name){case "all":c=
"selected";break;case "landscape":h="selected";break;case "portrait":p="selected";break;case "phone":g="selected"}f=f+(k+n)+'</div><div class="tdc-tab-responsive">';f+='<div class="tdc-responsive-buttons">';f+='<div class="tdc-responsive-all '+c+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(f+='<div class="tdc-responsive-tablet-landscape '+h+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');
f+='<div class="tdc-responsive-tablet-portrait '+p+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';f+='<div class="tdc-responsive-phone '+g+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';f+="</div>";f+="</div></div>";f+='<div class="tdc-sidebar-sticky-a"></div>';f+='<div class="tdc-sidebar-sticky-b"></div>';f+='<div class="tdc-tab-content-wrap">';n=h=k="";for(c=0;c<a.length;c++){g=tdcSidebarPanel._fixGroupName(a[c]);p=tdcUtil.makeSafeForCSS(g);
g="tdc-tab-no-design";var q=d.get("tag");"css"===p&&(g="tdc-tab-design");0===c?(k='<div class="tdc-tab-content tdc-tab-content-visible '+g+'" id="td-tab-'+p+'">',h='<div class="tdc-tab-content '+g+'" id="td-tab-'+p+'">',p=window.tdcAdminSettings.mappedShortcodes[q].tdc_start_values,d.unset("presetValues"),_.isUndefined(p)||(p=JSON.parse(window.atob(p)),_.isArray(p)&&1<p.length&&d.set("presetValues",p)),d.has("presetValues")&&(p=d.get("presetValues"),n+=tdcSidebarPanel._addPresetValuesSelector(p,d))):
_.isUndefined(l)||l!=="td-tab-"+p?n+='<div class="tdc-tab-content '+g+'" id="td-tab-'+p+'">':(k=h,n+='<div class="tdc-tab-content tdc-tab-content-visible '+g+'" id="td-tab-'+p+'">');n+=tdcSidebarPanel._bindGroupAndGetHtml(a[c],e,d);p=' data-model_id="'+d.cid+'" ';"vc_row"===d.attributes.tag?(n+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(n+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+p+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>'),
n+="</div>"):"vc_row_inner"===d.attributes.tag?(n+='<div class="tdc-sidebar-row-buttons">',n+="</div>"):"vc_column"!==d.attributes.tag&&"vc_column_inner"!==d.attributes.tag&&(n+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(n+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+p+' title="Get the current styles\' settings">CONSOLE: style presets</div>'),n+="</div>");n+="</div>"}f=f+(k+n)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(f);
...
c+'"]'),a.length)switch(a.attr("checked","checked"),a.next("label").show(),e){case "":case "11":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");a.parent().find("input[value=23_13] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_23] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_13_13] + label").removeClass("tdc-block-col");break;case "13":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");a.parent().find("input[value=23_13] + label").addClass("tdc-block-col");
a.parent().find("input[value=13_23] + label").addClass("tdc-block-col");a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":a.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),a.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})()}},_bindGroupAndGetHtml:function(d,b,e){var a=
"",c=e.get("attrs");if("tdc_zone"===e.get("tag"))var f=c.type;for(var g=0;g<b.params.length;g++){var l=b.params[g].param_name,k=b.params[g].group;if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[g].group)||b.params[g].group===d){if(!_.isUndefined(f)&&(!_.isUndefined(b.params[g].zone_group)&&f!==b.params[g].zone_group||"type"===l))continue;a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[g],e)}if("block_template_id"===l){k=c.block_template_id;_.isEmpty(k)&&(k=window.tdcAdminSettings.globalBlockTemplate);
l=window.tdcAdminSettings.mappedBlockTemplates;for(var h=0;h<l[k].params.length;h++)if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(l[k].params[h].group)||l[k].params[h].group===d)a+=tdcSidebarPanel._bindParamAndGetHtml(l[k].params[h],e)}else if(0===l.indexOf("tds_")){var n=l.split("-");h=n[0];var p;2===n.length?p=n[1]:2<n.length&&new tdcNotice.notice('Param "'+l+'" must have up to at most one "-" separator ',!0,!1);l=c[l];_.isEmpty(l)&&(l=window.tdcAdminSettings.globalStyle[h]);n=window.tdcAdminSettings.settingsStyle[h];
for(h=0;h<n[l].params.length;h++)if(k==d||_.isUndefined(k)&&d===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(n[l].params[h]));q.param_name=l+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);a+=tdcSidebarPanel._bindParamAndGetHtml(q,e)}}}return a},_bindParamAndGetHtml:function(d,b){switch(d.type){case "colorpicker":return tdcSidebarPanel.addColorpicker(d,b);case "gradient":return tdcSidebarPanel.addGradient(d,b);case "dropdown":return tdcSidebarPanel.addDropDown(d,b);
...
b);case "attach_image":return tdcSidebarPanel.addUploadImage(d,b);case "textfield":return tdcSidebarPanel.addTextField(d,b);case "textfield-responsive":return tdcSidebarPanel.addTextFieldResponsive(d,b);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(d,b);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(d,b);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),tdcCssEditor.addComposerCssEditor(d,b);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(d,
b);case "text_separator":return tdcSidebarPanel.addTextSeparatorHorizontal(d,b);case "font_header":return tdcSidebarPanel.addFontHeader(d,b);case "font_title":return tdcSidebarPanel.addFontTitle(d,b);case "font_reset":return tdcSidebarPanel.addFontReset(d,b);case "font_save":return tdcSidebarPanel.addFontSave(d,b);case "font_load":return tdcSidebarPanel.addFontLoad(d,b);case "font_settings":return tdcSidebarPanel.addFontSettings(d,b);case "shadow_header":return tdcSidebarPanel.addShadowHeader(d,b);
case "shadow_title":return tdcSidebarPanel.addShadowTitle(d,b);case "clearfix":return tdcSidebarPanel.addClearfix(d,b);case "tdc_hidden_field":return"";default:return d.param_name+" - "+d.type+"<br>"}},_deletePanel:function(){tdcSidebarPanel._hook._hooks=[];tdcSidebarPanel._currentBoundModel=f;tdcSidebarPanel.saveTdcPalette();jQuery(".tdc-breadcrumbs").hide();jQuery(".tdc-inspector .tdc-current-element-head").empty();jQuery(".tdc-inspector .tdc-tabs-wrapper").empty();jQuery(".tdc-inspector-wrap").removeClass("tdc-inspector-active");
jQuery(".tdc-empty-sidebar").show();tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible");tdcSidebar.$_currentElementHead.removeClass("tdc-current-element-siblings-button-on");delete window.tdcResponsiveValues;tdcSidebar.hideWpeditor()},_getParameterClasses:function(d){var b="tdc-property-wrap tdc-property-"+d.type;b+=" tdc-property-"+d.param_name;_.isUndefined(d["class"])||(b+=" "+d["class"]);return b},_getParameterCurrentValue:function(d,b){var e=b.get("attrs");
return _.isUndefined(e[d.param_name])?"dropdown"===d.type||_.isUndefined(d.value)?"":d.value:e[d.param_name]},_getParameterDomName:function(d){return"tdc-param-"+d.param_name},_getParamterDataAtts:function(d,b){var e="";if("undefined"===typeof b)return e;e+=' data-model_id="'+b.cid+'"';"undefined"!==typeof d&&(e+=' data-param_name="'+d.param_name+'"');return e},_fixGroupName:function(d){switch(d){case "Design options":return"Css";case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return d},
clearPanel:function(){tdcSidebarPanel._deletePanel()},blurInputPanel:function(){jQuery("body").find("input").blur()},_addPresetValuesSelector:function(d,b){var e='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div>'+('<ul class="tdc-preset-values-list" data-model_id="'+b.cid+'">');for(var a=1;a<d.length;a++){var c="";_.isUndefined(d[a].tdc_preset_individual)||(c=
'data-individual="1"');var f="";_.isUndefined(d[a].tdc_preset_class)||(f=' class="'+d[a].tdc_preset_class+'"');e+="<li "+c+" "+f+' data-values="'+window.btoa(JSON.stringify(d[a]))+'">'+d[a].tdc_preset_name+"</li>"}e+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return e},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});
jQuery(".tdc-preset-values-list > li").click(function(){var d=jQuery(this),b=d.data("individual"),e=d.parent(".tdc-preset-values-list");d=JSON.parse(window.atob(d.data("values")));var a=tdcIFrameData.getModel(e.data("model_id")),c={};_.isUndefined(b)||(c=_.clone(a.get("attrs")));_.isObject(d)&&(_.map(d,function(b,d){var e=!1;_.map(window.tdcAdminSettings.mappedShortcodes[a.get("tag")].params,function(a,g){a.param_name===d&&(e=!0,c[d]=b)});if(!e){var g=c.block_template_id;_.isUndefined(g)&&(g=window.tdcAdminSettings.globalBlockTemplate);
_.isUndefined(g)||_.map(window.tdcAdminSettings.mappedBlockTemplates[g].params,function(a,g){a.param_name===d&&(e=!0,c[d]=b)})}e||0!==d.indexOf("tds_")||(c[d]=b)}),a.set("attrs",c));tdcSidebarController.onUpdate(a)})},addColorpicker:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+
('<div class="tdc-colorpicker-wrap" title="'+d.heading+'">');a=a+"</div>"+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackColorPicker);return a},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();
jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-colorpicker-wrap");_.isUndefined(b.val())||""===b.val()||d.attr("style","background: "+b.val())})},addGradient:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div>'+
("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return a},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var d=
...
f+="<option "+h+' value="'+q+'">'+n+"</option>"}g="";_.has(d,"description")&&""!==d.description&&(g=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+g+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+f+"</select>");return c+"</div></div>"},addDropDownResponsive:function(d,b){var e=
!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",g=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&g.length<=parseInt(d.tdc_min_options))return c;var l=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var h=JSON.parse(window.atob(k));l=' data-responsive="'+k+'" ';"undefined"!==typeof h[tdcSidebar.currentViewportSettings.name]&&(k=h[tdcSidebar.currentViewportSettings.name])}catch(r){}for(h=
0;h<g.length;h++){var n=!1,p="",q=g[h],t=String(d.value[g[h]]);_.isObject(d.value[g[h]])&&(n=!0,t=_.values(d.value[g[h]])[0],q=_.keys(d.value[g[h]])[0]);if(e||a){0===h&&""===k&&(k=t);k===t&&(p=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+t+'">';e?(p="",
n&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+u+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+t+"</label>"}else k===t&&(p=' selected="selected" '),f+="<option "+p+' value="'+t+'">'+q+"</option>"}g="";_.has(d,"description")&&""!==d.description&&(g=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+
g+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+l+g+">",c=c+f+"</select>");return c+"</div></div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,
b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+a+"/>");return c+"</div></div>"},addCheckBoxResponsive:function(d,b){var e="",a=' data-responsive="" ',c=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var f=JSON.parse(window.atob(c));
a=' data-responsive="'+c+'" ';"undefined"!==typeof f[tdcSidebar.currentViewportSettings.name]&&(c=f[tdcSidebar.currentViewportSettings.name])}catch(g){}""!==c&&(e=" checked ");f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+e+a+"/>");return c+"</div></div>"},addRange:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);
var g="";_.has(d,"value")&&""!==d.value&&(g=d.value);var l="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(l=tdcSidebarPanel._getParameterCurrentValue(d,b));var k='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';k+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";k=k+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+l+'" data-min="'+c+'" data-max="'+
a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+l+'" />');return k=k+('<input type="text" class="tdc_range_value" data-default_value="'+g+'" value="'+l+'"/>')+"</div></div>"},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);
var g="";_.has(d,"value")&&""!==d.value&&(g=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var l="";_.has(d,"placeholder")&&""!==d.placeholder&&(l=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var k=' data-responsive="" ',h=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var n=JSON.parse(window.atob(h));k=' data-responsive="'+h+'" ';h="undefined"===typeof n[tdcSidebar.currentViewportSettings.name]?"":n[tdcSidebar.currentViewportSettings.name]}catch(p){}n=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';n+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";n=n+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+h+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+h+'" '+k+" />");return n=n+('<input type="text" class="tdc_range_value" data-default_value="'+
g+'" '+l+' value="'+h+'"/>')+"</div></div>"},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",g="",l=[],k="",h="",n="",p="",q="",t="",v="",u;for(u in a)a.hasOwnProperty(u)&&(l.push(a[u].unit),""===h||""===k)&&(p=a[u].unit,h=' data-range_unit="'+p+'" ',n=a[u].value,k=' data-range_value="'+n+'" ',q=a[u].range_min,t=a[u].range_max,v=a[u].range_step);if(""!==c){for(var r=
...
'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+r+' data-default_value="'+a[u].value+'" data-last_value="'+l+'"/>',g+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+
k+" "+h+" "+f+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+n+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+"</div>"+('<input type="text" class="tdc_range_value" value="'+n+'"/>');a+="</div>";a+="</div>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",g="",l=[],k=' data-responsive="" ',
h="",n="",p="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(l.push(a[r].unit),""===n||""===h)&&(q=a[r].unit,n=' data-range_unit="'+q+'" ',p=a[r].value,h=' data-range_value="'+p+'" ',t=a[r].range_min,v=a[r].range_max,u=a[r].range_step);if(""!==c){var w=c;try{var z=JSON.parse(window.atob(c));k=' data-responsive="'+c+'" ';w="undefined"===typeof z[tdcSidebar.currentViewportSettings.name]?"":z[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==w){c=[];for(z=0;z<l.length&&!(c=w.split(l[z]),
1<c.length);z++);c.length&&(q=l[z],n=' data-range_unit="'+q+'" ',p=c[0],h=' data-range_value="'+p+'" ')}}for(r in a)a.hasOwnProperty(r)&&(l=_.uniqueId(),f+=" data-value_"+r+'="'+a[r].value+'" ',f+=" data-min_"+r+'="'+a[r].range_min+'" ',f+=" data-max_"+r+'="'+a[r].range_max+'" ',f+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=p,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+
r+'" data-unit_value="'+a[r].unit+'" type="radio" id="'+l+'" '+c+' data-default_value="'+a[r].value+'" data-last_value="'+w+'"/>',g+='<label for="'+l+'">'+a[r].unit+"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="range" '+h+" "+n+" "+f+" "+k+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+"</div>"+('<input type="text" class="tdc_range_value" value="'+p+'"/>');a+="</div>";a+="</div>";return a+="</div>"},addIconSelector:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+
e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<div class="tdc-icon-wrap tdc-no-icon-selected" '+tdcSidebarPanel._getParamterDataAtts(d,b)+">");a+='</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div></div>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(a,e){var c=jQuery(e);if(d.param_name===c.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==f&&(c.html('<i class="'+f+'"></i>'),
...
window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");a+='</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,e){var c=jQuery(e);if(!c.parent().parent(".tdc-bg-upload").length&&d.param_name===c.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==f&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url",
...
c,b){})}})});return a},addTextField:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';f+='<div class="tdc-property-title"><span'+
e+">"+d.heading+"</span></div>";f=f+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" '+c+' value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');return f=f+a+"</div></div>"},addTextFieldResponsive:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+
d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';g="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(k){}l='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';
l+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+g+'" '+c+f+e+"/>");return l=l+a+"</div></div>"},addTextAreaHtml:function(d,b){_.has(d,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+b.cid+'" data-mapped_parameter_name="'+d.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(d,
...
addShadowTitle:function(d,b){return'<div class="tdc-sidebar-shadow-title '+tdcSidebarPanel._getParameterClasses(d)+'">'+tdcSidebarPanel._getParameterCurrentValue(d,b)+"</div>"},addClearfix:function(d,b){return'<div class="clearfix"></div>'},updateTextfieldResponsiveValues:function(d,b,e){"undefined"===typeof window.tdcResponsiveValues[d]?""!==b&&(window.tdcResponsiveValues[d]={},window.tdcResponsiveValues[d][e]={viewportName:b}):""===b?delete window.tdcResponsiveValues[d][e]:window.tdcResponsiveValues[d][e]=
...
l),d.val(c),h=e.find('input[type="radio"][data-unit_value="'+l+'"]'),k=h.data("unit"),f=d.data("min_"+k),l=d.data("max_"+k),k=d.data("step_"+k),g=d.get(0),h.prop("checked",!0),g.min=f,g.max=l,g.step=k,g.value=c,h.data("last_value",c),e.find('input[type="text"]').val(c))}}},showShortcodeFromPath:function(d){if(!_.isUndefined(d)){d=d.toString().split("_");var b;d.forEach(function(a,d){if(""!==a)if(_.isUndefined(b))b=tdcIFrameData.tdcTopCollection.at(a);else{var c=b.get("childCollection");!_.isUndefined(c)&&
...
window.tdcAdminSettings.tdbHeaderTemplates.forEach(function(b){tdcSidebar.$_headerTemplateList.append('<option value="'+b.val+'">'+b.text+"</option>")});tdcState.isGlobalTemplate()?tdcSidebar.$_headerTemplateList.find("option:first").attr("selected",!0):tdcState.isNoHeader()?tdcSidebar.$_headerTemplateList.find('option[value="no_header"]').attr("selected",!0):tdcSidebar.$_headerTemplateList.find('option[value="tdb_template_'+tdcState.getHeaderTemplateId()+'"]').attr("selected",!0);tdcSidebar.$_buttonZone.click(function(){tdcSidebar.$_tdcZone.show();
tdcWindowFrame.setWindowFrame(tdcSidebar.$_tdcZone)});tdcSidebar.$_tdcZone.on("click",".tdc-zone-icon",function(d){d=f(this).parent();var a=d.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");d.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(tdcIFrameData.activateZone(a,!0,!0),d.addClass("tdc-zone-sticky-active"),d.removeClass("tdc-zone-sticky-inactive")):tdcIFrameData.activateZone(a,b,!0)}).on("click",".tdc-zone-sticky-info",
function(d){d=f(this).parent();var a=d.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");d.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(d.hasClass("tdc-zone-sticky-inactive")?tdcIFrameData.activateZone(a,!0,!0):tdcIFrameData.activateZone(a,!1),d.toggleClass("tdc-zone-sticky-active"),d.toggleClass("tdc-zone-sticky-inactive")):tdcIFrameData.activateZone(a,b,!0)}).on("change",".tdc-header-template-list",function(b){b=f(this);
tdcSidebar.getHeaderTemplate(b.val().replace("tdb_template_",""))});tdcSidebar.$_editZone.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentZone)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentZone)}).mouseleave(function(b){tdcMaskUI.hide()});tdcSidebar.$_editRow.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
...
tdcSidebar.$_liveIframeWrapper.hasClass("tdc-live-iframe-wrapper-inline")||tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-full");tdcMain.resetSidebarHidden()});tdcSidebar.$_sidebarMenu.click(function(b){f(this).toggleClass("tdc-window-open");f(".tdc-sidebar-modal").each(function(a,c){var b=f(c),d=b.data("button_class");b.hasClass("tdc-sidebar-modal-menu")?b.toggleClass("tdc-modal-open"):(b.removeClass("tdc-modal-open"),"undefined"!==typeof d&&""!==d&&(b=f("."+d),b.length&&b.removeClass("tdc-window-open")))})});
tdcSidebar.$_sidebarSearch.keyup(function(b){var a=f(this);f(".tdc-sidebar-element").each(function(c,b){var d=f(b);-1===d.find(".tdc-element-id").html().toLowerCase().indexOf(a.val().trim().toLowerCase())?d.hide():d.show()});f(".tdc-sidebar-separator").each(function(a,b){var c=f(b);c.nextUntil(".tdc-sidebar-separator").is(":visible")?c.show():c.hide()})});tdcSidebar.$_sidebar.on("mouseenter",function(){tdcSidebar.mouseOverSidebar=!0}).on("mouseleave",function(){tdcSidebar.mouseOverSidebar=!1});f("body").css("overflow",
...
"HEADER MENU STICKY";break;case "tdc_header_mobile":a="MOBILE MENU";break;case "tdc_header_mobile_sticky":a="MOBILE MENU STICKY"}tdcSidebar.$_editZone.find("a").html(a)},_activeBreadcrumbItem:function(){var b=tdcSidebar.getCurrentModel(),a=b.get("tag"),c=tdcIFrameData.getZoneParent(b).get("type_zone"),m="<span>"+window.tdcPostSettings.shortcodes[b.get("tag")]+"</span>",g="";tdcSidebar.changeZoneName(c);for(var l in window.tdcAdminSettings.mappedShortcodes)"undefined"===typeof window.tdcAdminSettings.mappedShortcodes[l].tdc_category||
"Blocks"!==window.tdcAdminSettings.mappedShortcodes[l].tdc_category&&"Big Grids"!==window.tdcAdminSettings.mappedShortcodes[l].tdc_category||window.tdcAdminSettings.mappedShortcodes[l].tdc_category!==window.tdcAdminSettings.mappedShortcodes[a].tdc_category||(c="",l===a&&(c="tdc-selected-option"),g+='<li class="'+c+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[l].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[l].base+'"></div><div class="tdc-element-id">'+
window.tdcAdminSettings.mappedShortcodes[l].name+"</div></li>");""!==g?(g="<ul>"+g+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):tdcSidebar.$_currentElementHead.removeClass("tdc-block-selection");switch(a){case "tdc_zone":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();var k=tdcSidebar.$_editZone;break;case "vc_row":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.hide();
tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editRow;break;case "vc_column":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editColumn;break;case "vc_row_inner":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();
k=tdcSidebar.$_editInnerRow;break;case "vc_column_inner":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.show();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editInnerColumn;break;default:tdcSidebar.$_editZone.show(),tdcSidebar.$_editRow.show(),tdcSidebar.$_editColumn.show(),k=tdcSidebar.getCurrentElement(),"vc_column_inner"===b.get("parentModel").get("tag")?(tdcSidebar.$_editInnerRow.show(),tdcSidebar.$_editInnerColumn.show()):
(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(m);tdcSidebar.$_currentElementSiblings.html(g);tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();k.trigger(a)}).mouseleave(function(a){a.preventDefault();k.trigger(a)}).mousedown(function(a){""!==g&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),a=f(this),tdcSidebar.$_currentElementSiblings.hasClass("tdc-current-element-siblings-visible")?
a.addClass("tdc-current-element-siblings-button-on"):a.removeClass("tdc-current-element-siblings-button-on"))});tdcSidebar.$_currentElementSiblings.find("li").off().click(function(a){a=f(this);var c=a.data("block_type"),e=a.children(".tdc-element-id").html();a.siblings(".tdc-selected-option").removeClass("tdc-selected-option");a.addClass("tdc-selected-option");tdcSidebar.$_currentElementHead.html("<span>"+e+"</span>");d.isUndefined(c)||(b.set("tag",c),b.set("rebindToPanel",!0),tdcSidebarController.onUpdate(b));
tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_currentElementSiblings.mouseleave(function(a){tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_inspector.show()},closeModals:function(){f(".tdc-sidebar-modal").each(function(b,a){var c=f(a),d=c.data("button_class");c.removeClass("tdc-modal-open");"undefined"!==typeof d&&""!==d&&(c=f("."+d),c.length&&c.removeClass("tdc-window-open"))})},_sidebarModal:function(){f(".tdc-add-element").click(function(){f(this).toggleClass("tdc-window-open");
...
c)d.isUndefined(tdcSidebar._currentModel)||tdcSidebar._currentModel.set("current",!1),console.log(e),d.isUndefined(e)?(tdcSidebar._setCurrentZone(b),tdcSidebar._setCurrentRow(b),tdcSidebar._setCurrentColumn(b),tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=b):d.has(e,"$currentZone")&&!d.isUndefined(e.$currentZone)?(tdcSidebar._setCurrentZone(e.$currentZone),d.has(e,"$currentRow")&&!d.isUndefined(e.$currentRow)?(tdcSidebar._setCurrentRow(e.$currentRow),
d.has(e,"$currentColumn")&&!d.isUndefined(e.$currentColumn)?(tdcSidebar._setCurrentColumn(e.$currentColumn),d.has(e,"$currentInnerRow")&&!d.isUndefined(e.$currentInnerRow)?(tdcSidebar._setCurrentInnerRow(e.$currentInnerRow),d.has(e,"$currentInnerColumn")&&!d.isUndefined(e.$currentInnerColumn)?(tdcSidebar._setCurrentInnerColumn(e.$currentInnerColumn),d.has(e,"$currentElement")&&!d.isUndefined(e.$currentElement)?(tdcSidebar._setCurrentElement(e.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentElement.data("model_id"))):
...
('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+c()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Width</span></div><div class="tdc-property">'+
('<input class="tdc-css-width" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Shadow size</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-size" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h">Shadow offset H</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-offset-h" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v">Shadow offset V</span></div><div class="tdc-property">'+('<input class="tdc-css-shadow-offset-v" '+
...
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction">Gradient direction</span></div><div class="tdc-property">'+
('<input class="tdc-css-gradient-direction" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",b,e());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-content-h-align" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);h+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("z-index","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';
h=h+'<div class="tdc-property-title"><span title="Z-index">Z-index</span></div><div class="tdc-property">'+('<input class="tdc-css-z-index" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align">Display</span></div><div class="tdc-property">'+
('<select class="tdc-css-display" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],n);h=h+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>'+
('<div class="tdc-clear-css-properties" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' title="Clear all tab css settings">Clear CSS settings</div>');h+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){f(".tdc-inherit").each(function(a,c){var e=f(c),g=e.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||g.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))e.hide();else{var l=g.data("tdc-for");
g={isInherited:!1};l=tdcCssEditor._getSettingsProperty(l,b,g);g.isInherited?e.hide():d.isUndefined(l)||e.show()}})});return h},_getAvailableViewportSetting:function(b,a,c){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(b){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]&&(d="all");break;case "landscape":case "portrait":case "phone":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]?d=b:"undefined"!==typeof tdcCssEditor._currentCssSettings.all&&(d="all")}if("undefined"!==
...
typeof d&&"undefined"!==typeof a&&(d=a);return d},_generateDropdownOptions:function(b,a,c){for(var e=[],f,l=!1,k=0,h=0;h<b.length;h++)d.isUndefined(c)||c!==b[h].value||(k=h),f="",d.isUndefined(a)||a!==b[h].value||(f='selected="selected"',l=!0),e.push("<option "+f+' value="'+b[h].value+'">'+b[h].display+"</option>");l||(e[k]='<option selected="selected" value="'+b[k].value+'">'+b[k].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),
e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),l=b.find(".tdc-css-box-input-margin-left").val().trim(),k=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),
v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),r=b.find(".tdc-css-border-radius").val().trim(),w=b.find(".tdc-css-width").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),A=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==c&&(a["margin-top"]=
c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==l&&(a["margin-left"]=l);""!==k&&(a["border-top-width"]=k);""!==h&&(a["border-right-width"]=h);""!==n&&(a["border-bottom-width"]=n);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=
e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||1!==c||(a["border-color"]="no_value"));""!==r&&(a["border-radius"]=r);""!==w&&(a.width=w);""!==z&&(a["shadow-size"]=z);r=b.find(".tdc-css-shadow-color");w=r.val().trim();""!==w?a["shadow-color"]=w:(r=r.data("no_value"),d.isUndefined(r)||1!==r||(a["shadow-color"]="no_value"));""!==x&&(a["shadow-offset-h"]=x);""!==A&&(a["shadow-offset-v"]=A);x=b.find(".tdc-css-bg-color");A=x.val().trim();
""!==A?a["background-color"]=A:(x=x.data("no_value"),d.isUndefined(x)||1!==x||(a["background-color"]="no_value"));x=b.find(".tdc-css-bg-image");x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(x=x.data("image_link"),d.isUndefined(x)||("no_value"===x?a["background-image"]="no_value":""!==x&&(a["background-image"]='url("'+x+'")')));x=b.find(".tdc-css-bg-style");A=x.val().trim();""===A||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-style"]=
A);x=b.find(".tdc-css-bg-position");A=x.val().trim();""===A||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-position"]=A);""!==y&&(a.opacity=y);y=b.find(".tdc-css-color-1-overlay");x=y.val().trim();""!==x?a["color-1-overlay"]=x:(y=y.data("no_value"),d.isUndefined(y)||1!==y||(a["color-1-overlay"]="no_value"));y=b.find(".tdc-css-color-2-overlay");x=y.val().trim();""!==x?a["color-2-overlay"]=x:(y=y.data("no_value"),d.isUndefined(y)||1!==y||(a["color-2-overlay"]=
...
tdcContextMenu.$_saveShortcode=tdcContextMenu.$_context.find(".tdc-save-shortcode");tdcContextMenu.$_deleteShortcode=tdcContextMenu.$_context.find(".tdc-delete-shortcode");tdcContextMenu.$_cloneShortcode=tdcContextMenu.$_context.find(".tdc-clone-shortcode");tdcContextMenu.$_clearShortcode=tdcContextMenu.$_context.find(".tdc-clear-shortcode");tdcContextMenu.$_context.find("li:not(.active)").on("click",function(f){f.preventDefault();return!1});tdcContextMenu.$_context.bind("contextmenu",function(f){f.preventDefault();
var d=jQuery.Event("click");d.pageX=f.pageX;d.pageY=f.pageY;tdcContextMenu.$_context.trigger(d)});tdcContextMenu.$_copyShortcode.on("click",tdcContextMenu.copyShortcodeHandler);tdcContextMenu.$_cutShortcode.on("click",tdcContextMenu.cutShortcodeHandler);tdcContextMenu.$_pasteShortcodeBefore.on("click",tdcContextMenu.pasteBeforeShortcodeHandler);tdcContextMenu.$_pasteShortcodeAfter.on("click",tdcContextMenu.pasteAfterShortcodeHandler);tdcContextMenu.$_copyStyle.on("click",function(f){f=tdcSidebarPanel.getCurrentStyleSettings(f,
tdcContextMenu._model);if(!_.isUndefined(f)){for(var d=tdcContextMenu._model.get("tag"),b=window.tdcAdminSettings.mappedShortcodes[d].tdc_style_params,e=0;e<b.length;e++)delete f[b[e]];tdcUtil.setStorageItem("copyStyleType",d);tdcUtil.setStorageItem("copyStyleAttrs",f)}tdcContextMenu.hide()});tdcContextMenu.$_pasteStyle.on("click",function(f){f=tdcUtil.getStorageItem("copyStyleType");var d=tdcUtil.getStorageItem("copyStyleAttrs");if(!_.isUndefined(f)&&!_.isUndefined(d)&&!_.isUndefined(tdcContextMenu._model)){var b=
tdcContextMenu._model.get("tag");if(b!==f)return;f=tdcContextMenu._model.get("attrs");var e=_.clone(d);for(a in e)e[a]=d[a];var a=window.tdcAdminSettings.mappedShortcodes[b].tdc_style_params;if(!_.isUndefined(a))for(d=0;d<a.length;d++)f.hasOwnProperty(a[d])&&(e[a[d]]=f[a[d]]);tdcContextMenu._model.set("attrs",e);tdcSidebarController.onUpdate(tdcContextMenu._model);tdcSidebarPanel.clearPanel()}tdcContextMenu.hide()});tdcContextMenu.$_resetStyle.on("click",function(f){if(!_.isUndefined(tdcContextMenu._model)){var d=
tdcContextMenu._model.get("tag"),b=tdcContextMenu._model.get("attrs");f=_.clone(b);var e=window.tdcAdminSettings.mappedShortcodes[d].tdc_style_params;if(!_.isUndefined(e)){for(var a in b){b=!1;for(var c=0;c<e.length;c++)if(a===e[c]){b=!0;break}if("tdc_zone"!==d||"type"!==a)b||delete f[a]}if(!_.isUndefined(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values)){a=JSON.parse(tdcUtil.b64DecodeUnicode(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values));Array.isArray(a)&&(a=a[0]);for(var m in a)f.hasOwnProperty(m)||
(f[m]=a[m])}}tdcContextMenu._model.set("attrs",f);tdcSidebarController.onUpdate(tdcContextMenu._model)}tdcContextMenu.hide()});tdcContextMenu.$_saveShortcode.on("click",tdcContextMenu.saveShortcodeHandler);tdcContextMenu.$_deleteShortcode.on("click",tdcContextMenu.deleteHandler);tdcContextMenu.$_cloneShortcode.on("click",tdcContextMenu.cloneHandler);tdcContextMenu.$_clearShortcode.on("click",function(f){var d={error:void 0,getShortcode:""};if(!_.isUndefined(tdcContextMenu._model)){f=tdcContextMenu._model.get("tag");
var b=tdcContextMenu._model.get("childCollection");if(!_.isUndefined(b))if("vc_column"===f||"vc_column_inner"===f)b.reset();else if("vc_row"===f||"vc_row_inner"===f)_.map(b.models,function(a,b){var c=a.get("childCollection");_.isUndefined(c)||c.reset()});else if("tdc_zone"===f){var e;_.map(b.models,function(a,b){_.isUndefined(e)&&(e=a);var c=a.get("childCollection");_.map(c.models,function(a,b){var c=a.get("childCollection");_.isUndefined(c)||c.reset()})});b=new tdcIFrameData.TdcCollection;b.add(e,
{at:0});tdcContextMenu._model.set("childCollection",b)}tdcIFrameData._checkModelData(tdcContextMenu._model,d);if(!_.isUndefined(d.getShortcode)){d=tdcContextMenu._getCurrentElementOver();b="tdc-element-column";if("vc_column_inner"===f||"vc_row_inner"===f||"vc_row"===f)b="tdc-element-inner-column";d.find(".tdc-elements").html('<div class="tdc-element-empty '+b+'" title="Empty element that should be removed by composer"></div>').addClass("tdc-dropped");tdcSidebarController.onUpdate(tdcContextMenu._model)}}tdcContextMenu.hide()})},
...
g=f(".tdc-color-values");-1!==e&&(d.tdcAdminSettings.tdcSavings.recentColors.splice(e,1),f('.tdc-color-value[data-color="'+a+'"]').remove());d.tdcAdminSettings.tdcSavings.recentColors.push(b);23<=d.tdcAdminSettings.tdcSavings.recentColors.length&&(g.find(".tdc-color-value:last").remove(),d.tdcAdminSettings.tdcSavings.recentColors.splice(0,1));tdcUtil.updateTdcSavings();g.prepend('<div class="tdc-color-value" data-color="'+a+'" style="background-color:'+a+'"><div class="tdc-color-value-delete"></div>')}}});
"undefined"===typeof f.fn.tdGradient&&(f.fn.tdGradient=function(){return this.each(function(){var a=this,b=f(this);a.$this=b;if(!1!==b.data("rgba")){var m=f.cs_ParseColorValue(b.val());b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},change:function(c,d){var e=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",e);b.val(e).trigger("change");a.triggerSelection?a.setColor(e,!0):a.setColor(e)},create:function(){var c=b.data("a8cIris"),
l=b.closest(".wp-picker-container"),k=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(l.find(".wp-picker-holder")),h=k.find(".cs-alpha-slider"),n=k.find(".cs-alpha-text"),p=k.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-gradient-result-wrap"></div>').prependTo(l);q=f('<div class="tdc-gradient-result"><div class="tdc-gradient-color tdc-gradient-left-color"></div><div class="tdc-gradient-color tdc-gradient-right-color"></div></div>').prependTo(q);
f('<div class="tdc-gradient-degree-label">deg.</div><input class="tdc-gradient-degree" placeholder="0">').appendTo(l.find(".wp-picker-input-wrap"));f('<div class="tdc-gradient-result-labels"><div class="tdc-gradient-result-label">Solid color</div><div class="tdc-gradient-result-label tdc-gradient-result-percentage"></div><div class="tdc-gradient-result-label">Gradient</div></div>').prependTo(l);f('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(l);var t=f('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(l),
v=f('<div class="tdc-gradient-values-wrapper"></div>').appendTo(l);v=f('<div class="tdc-gradient-values"></div>').appendTo(v);if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.gradients&&d.tdcAdminSettings.tdcSavings.gradients.length)for(var u=!1,r=d.tdcAdminSettings.tdcSavings.gradients.length-1;0<=r;r--){var w=d.tdcAdminSettings.tdcSavings.gradients[r];try{var z=JSON.parse(d.atob(w));"undefined"!==typeof z.css&&(u=!0,f('<div class="tdc-gradient-value" style="'+z.css+'" data-gradient="'+w+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(v))}catch(x){}}u||
t.hide();a.$container=l;a.$gradientResult=q;h.slider({slide:function(a,d){var e=parseFloat(d.value/100);c._color._alpha=e;b.tdGradientColorPicker("color",c._color.toString());n.text(1>e?e:"")},create:function(){var d=parseFloat(m.alpha/100);n.text(1>d?d:"");p.css("background-color",m.value);l.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");h.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});l.on("click",".wp-picker-default",function(){var a=
f.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;n.text(1>d?d:"");h.slider("option","value",a.alpha).trigger("slide")});l.on("click",".wp-color-result",function(a){k.toggle()});f("body").on("click.wpcolorpicker",function(){k.hide()});l.on("change keyup",".tdc-gradient-degree",function(b){b=f(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:m.alpha,step:1,min:0,max:100})}})}else b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},
...
b/(c.width()-d.outerWidth(!0)));d.css("left",b);d.data("percentage",c);a.currentColor="mixed"}}),a.$container.on("mouseup",".tdc-gradient-mix-color",function(b){f(this).removeClass("tdc-gradient-current-mix");a.eventOffsetX=e}),a.$container.on("mousemove",".tdc-gradient-result",function(b){var c=a.$container.find(".tdc-gradient-result-percentage"),d=a.$container.find(".tdc-gradient-result"),e=d.find(".tdc-gradient-right-color"),f=d.find(".tdc-gradient-current-mix");if(f.length){var g=0;"undefined"!==
...
tdcLivePanel.$tdbPostSettings=tdcLivePanel.$panel.find("#tdb_post_settings");if(0!==tdcLivePanel.$tdbPostSettings.length){var b=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver,d=function(a){(new b(function(b){"value"===b[0].attributeName&&$(a).trigger("change")})).observe(a,{attributes:!0})};tdcLivePanel.$panel.find(".td-box input[type=hidden]").each(function(a,b){d(b)});tdcLivePanel.$panel.on("change","input",function(a){a.preventDefault();tdcLivePanel.$tdbPostSettings.data("changed",
!0)})}tdcLivePanel.$tdcIframeCover=jQuery("#tdc-iframe-cover");tdcLivePanel.$panel.submit({},function(a){var b=jQuery("#tdc-live-iframe-temp");b.load(function(){var a=jQuery(this);if("tdc-live-iframe-temp"!==a.attr("id"))tdcAdminIFrameUI.checkIframe(a);else{var c=jQuery("#tdc-live-iframe");tdcLivePanel.$tdcIframeCover.removeClass("tdc-iframe-cover-show");c.addClass("tdc-remove-iframe");setTimeout(function(){b.attr("class",c.attr("class"));b.removeClass("tdc-remove-iframe");c.remove();b.attr("id",
"tdc-live-iframe");tdcAdminIFrameUI.checkIframe(b);tdcLivePanel.$panel.attr("action","")},400)}})});tdcLivePanel.$panel.on("change","#tdc_page_template",function(a){a.preventDefault();a=jQuery(this);var b=a.data("control-id");jQuery("#hidden_"+b).val(a.closest(".td-box").attr("id"));tdcLivePanel.submit()});tdcLivePanel.$panel.on("click",".tdc-page-template",function(a){a=jQuery(this);var b=a.data("control-id");jQuery("#hidden_"+b).val(a.closest(".td-box").attr("id"));tdcLivePanel.submit()});tdcLivePanel.$panel.on("click",
".tdc-panel-menu",function(a){var b=jQuery(this);a=b.data("menu_id");b=b.data("menu_name");tdcLivePanelMenuSettings.showSettings(a,b)});tdcLivePanel.$panel.on("click",".tdc-page-settings",function(a){tdcLivePanelPageSettings.showSettings()})},setCurrentSettingsPanel:function(b){if(!f.isUndefined(b)){if(!f.isUndefined(tdcLivePanel._currentSettingsPanel)){if(tdcLivePanel._currentSettingsPanel===b)return;var d=tdcLivePanel._currentSettingsPanel.hasClass("clear-position"),a=d?tdcLivePanel._currentSettingsPanel.getPosition(!1):
tdcLivePanel._currentSettingsPanel.getPosition(!0);tdcLivePanel._currentSettingsPanel.removeClass("clear-position");tdcLivePanel._currentSettingsPanel.closeSettings()}tdcLivePanel._currentSettingsPanel=b;!f.isUndefined(d)&&d&&(tdcLivePanel._currentSettingsPanel.addClass("clear-position"),tdcLivePanel._currentSettingsPanel.setPosition(a))}},getCurrentSettingsPanel:function(){return tdcLivePanel._currentSettingsPanel},submit:function(){var b=jQuery("#tdc-live-iframe");f.isUndefined(tdcLivePanel._iframeSrc)&&
(tdcLivePanel._iframeSrc=b.attr("src"));var e="uid_"+Math.floor(1E4*Math.random()+1)+"_"+Math.floor(100*Math.random()+1),a=jQuery('<iframe id="tdc-live-iframe-temp" name="'+e+'" scrolling="auto" src="about:blank" style="width: 100%; height: 100%" class="tdc-live-iframe-temp"></iframe>');a.insertAfter(b);a.load(function(){jQuery(a.get(0).contentWindow).scrollTop(jQuery(b.get(0).contentWindow).scrollTop())});tdcLivePanel.$panel.attr("target",e);tdcLivePanel.$panel.attr("action",tdcLivePanel._iframeSrc);
tdcLivePanel.$tdcIframeCover.show();tdcLivePanel.$tdcIframeCover.addClass("tdc-iframe-cover-show");e={error:d,getShortcode:""};tdcIFrameData.getShortcodeFromData(e);f.isUndefined(e.error)||tdcDebug.log(e.error);f.isUndefined(e.getShortcode)||(tdcLivePanel.$tdcContent.val(e.getShortcode),window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(e.getShortcode));tdcLivePanel.$tdcAction.val("preview");tdcLivePanel.$tdcCustomized.val(JSON.stringify(window.tdcAdminSettings.customized));tdcLivePanel.$panel.submit()}};
tdcLivePanel.init()})(_);function preinit(f){api.menuList=f.find("#menu-to-edit");api.targetList=api.menuList}var tdcLivePanelMenuSettings;
