...
if (TD_DEBUG_LIVE_THEME_STYLE) {
    add_action('wp_footer', 'td_theme_style_footer');
	    ...
	    function td_theme_style_footer() {
		    ?>
            <a href="https://demo.tagdiv.com/select_demo/select_demo_newspaper#demos" target="_blank" id="td-theme-demos-button" class="td-right-demos-button">DEMOS</a>
            <a href="https://themeforest.net/item/newspaper/5489609?license=regular&open_purchase_for_item_id=5489609&purchasable=source" id="td-theme-buy-button" class="td-right-demos-button">BUY</a>
		    <?php
	    }
