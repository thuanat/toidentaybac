		...
		<section class="yoast-seo-premium-extension">
			...
			<?php if ( $extension_list->is_installed( $premium_extension->get_title() ) ) : ?>
				...
				<?php if ( $has_valid_premium_subscription ) : ?>
					<div class="yoast-button yoast-button--noarrow yoast-button--extension yoast-button--extension-activated"><?php esc_html_e( 'Activated by TheDevKit', 'wordpress-seo' ); ?></div>
